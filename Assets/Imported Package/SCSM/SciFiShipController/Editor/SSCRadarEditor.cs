...
namespace SciFiShipController
{
    ...
    public class SSCRadarEditor : Editor
    {
        ...
        {
            SSCRadar r = SSCRadar.GetOrCreateRadar(UnityEngine.SceneManagement.SceneManager.GetActiveScene().handle);
