...
namespace SciFiShipController
{
    ...
    public class PlayerInputModuleEditor : Editor
    {
        ...
        private string metaCoreXRVersion = "";
        ...
        private readonly static GUIContent xrMetaCoreXRVersionContent = new GUIContent(" Meta Core version", "The version of the Meta Core plugin installed from Package Manager");
        ...
        public void OnEnable()
        {
            ...
            metaCoreXRVersion = SSCSetup.GetPackageVersion("Packages/com.meta.xr.sdk.core/package.json");
        ...
        public override void OnInspectorGUI()
        {
            ...
            else if (inputModeProp.intValue == (int)PlayerInputModule.InputMode.UnityXR && !isRefreshing)
            {
                ...
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField(xrMetaCoreXRVersionContent, GUILayout.Width(defaultEditorLabelWidth));
                EditorGUILayout.LabelField(string.IsNullOrEmpty(metaCoreXRVersion) ? xrPluginNotInstalled : metaCoreXRVersion);
                EditorGUILayout.EndHorizontal();
            ...
            if (isDebuggingEnabled && shipInput != null && playerInputModule != null)
            {
                ...
                if (shipControlModule != null)
                {
                    ...
                    Vector3 shipVelo = shipControlModule.IsInitialised ? shipControlModule.shipInstance.LocalVelocity : Vector3.zero;
                    EditorGUILayout.LabelField((shipVelo.z * 3.6f).ToString("0.0"), GUILayout.MaxWidth(defaultEditorFieldWidth));
                }
                EditorGUILayout.EndHorizontal();
