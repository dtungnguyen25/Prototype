...
namespace SciFiShipController
{
    ...
    public class DestructModuleEditor : Editor
    {
        ...
        private readonly static GUIContent isAddShipVelocityContent = new GUIContent("Add Ship Velocity", "The fragments move in the direction the ship was when the destruction occurred.");
        private readonly static GUIContent retainedVelocityForceContent = new GUIContent("Retained Force", "When Add Ship Velocity is enabled, the retained additional force applied to each fragment, relative to its mass, in the direction of travel.");
        ...
        private readonly static GUIContent massContent = new GUIContent("Total Mass (kg)", "The total mass, in kilograms, of all fragments in the prefab");
        ...
        private SerializedProperty isAddShipVelocityProp;
        private SerializedProperty retainedVelocityForceProp;
        ...
        public void OnEnable()
        {
            ...
            isAddShipVelocityProp = serializedObject.FindProperty("isAddShipVelocity");
            retainedVelocityForceProp = serializedObject.FindProperty("retainedVelocityForce");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(isAddShipVelocityProp, isAddShipVelocityContent);
            if (isAddShipVelocityProp.boolValue)
            {
                EditorGUILayout.PropertyField(retainedVelocityForceProp, retainedVelocityForceContent);
            }
