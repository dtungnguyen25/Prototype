...
namespace SciFiShipController
{
    ...
    public class BeamModuleEditor : Editor
    {
        ...
        private readonly static GUIContent damageCurveContent = new GUIContent("Damage Curve", "The amount of damage the beam will inflict on the target relative to the distance to the target. The maximum range is speed times the discharge duration.");
        ...
        private SerializedProperty damageCurveProp;
        ...
        public void OnEnable()
        {
            ...
            damageCurveProp = serializedObject.FindProperty("damageCurve");
        ...
        public override void OnInspectorGUI()
        {
            ...
            SSCCurve.CurvePreset curvePreset = (SSCCurve.CurvePreset)EditorGUILayout.EnumPopup("Preset", BeamModule.DefaultDamageCurvePreset);
            if (EditorGUI.EndChangeCheck())
            {
                damageCurveProp.animationCurveValue = SSCCurve.GetCurveFromPreset(curvePreset);
            }

            EditorGUILayout.PropertyField(damageCurveProp, damageCurveContent);
