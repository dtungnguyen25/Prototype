...
namespace SciFiShipController
{
    ...
    public class DemoFloatingPoint : MonoBehaviour
    {
        ...
        [Range(500f,5000f)] public float maxMoveDistance = 500f;
        ...
        void Start()
        {
            ...
            {
                // As the ship travels faster, the distance travelled per frame becomes
                // more. We don't want to be moving everything too often.
                if (maxMoveDistance < 500f) { maxMoveDistance = 500f; }
