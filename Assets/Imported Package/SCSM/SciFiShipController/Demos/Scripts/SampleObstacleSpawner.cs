    ...
    public class SampleObstacleSpawner : MonoBehaviour
    {
        ...
        public bool ConvertPrefabsToEntities()
        {
            ...
            if (numObstaclePrefabs > 0 && useDOTS)
            {
                ...
                {
                    #region Construct Entity Prefabs and Archetypes
                    ...
                    for (int pfIdx = 0; pfIdx < numObstaclePrefabs; pfIdx++)
                    {
                        ...
                        //entityManager.AddComponent(prefabEntity, typeof(Prefab));

                        entityManager.AddComponentData(prefabEntity, new LocalTransform { Rotation = Quaternion.identity, Scale = 1 });
                        entityManager.AddComponentData(prefabEntity, new Asteroid());
                        ...
                        if (prefabRootTransform.childCount > 0)
                        {
                            ...
                            linkedEntityList.Add(prefabEntity);
                            ...
                            if (linkedEntityList.Length > 1)
                            {
                                ...
                                DynamicBuffer<LinkedEntityGroup> linkedEntityGroup = entityManager.AddBuffer<LinkedEntityGroup>(prefabEntity);
                        ...
                        archetypeComponentTypeArray[1] = typeof(Asteroid);
                        #else
                        // ECS 0.51
        ...
        {
            if (asteroidSystem != null) { asteroidSystem = null; }
            ...
            DOTSHelper.DestroyWorld(ref asteroidWorld);
        }
        #endif
        #endregion
