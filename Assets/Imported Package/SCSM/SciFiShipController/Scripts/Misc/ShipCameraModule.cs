...
namespace SciFiShipController
{
    ...
    public class ShipCameraModule : MonoBehaviour
    {
        ...
        /// <summary>
        /// Get or set if the orbit feature is available for use
        /// </summary>
        public bool IsOrbitAvailable { get { return isOrbitAvailable; } set { SetIsOrbitAvailable(value); } }

        /// <summary>
        /// Is the orbit feature in use?
        /// </summary>
        public bool IsOrbitEnabled { get { return isOrbitEnabled; } }
        ...
        /// <summary>
        /// Make the orbit camera feature available for use
        /// </summary>
        [SerializeField] private bool isOrbitAvailable = true;

        /// <summary>
        /// Is the camera currently orbiting the ship?
        /// </summary>
        ...
        private void EnableOrDisableOrbit(bool isEnabled)
        {
            ...
            if (isEnabled != isOrbitEnabled && (!isEnabled || isOrbitAvailable))
            {
                currentOrbitHorizInput = 0f;
                currentOrbitVertInput = 0f;
                previousOrbitHorizInput = 0f;
        ...
        public virtual void ApplyCameraSettings (ShipCameraSettings shipCameraSettings)
        {
            if (shipCameraSettings != null)
            {
                ...
                orbitDistance = shipCameraSettings.orbitDistance;
                orbitHorizDamping = shipCameraSettings.orbitHorizDamping;
                orbitVertDamping = shipCameraSettings.orbitVertDamping;
                orbitSpeed = shipCameraSettings.orbitSpeed;
                orbitGroundMask = shipCameraSettings.orbitGroundMask;
                orbitGroundDetectOffset = shipCameraSettings.orbitGroundDetectOffset;
                isOrbitGroundDetection = shipCameraSettings.isOrbitGroundDetection;
                #endregion
                ...
                SetIsOrbitAvailable(shipCameraSettings.isOrbitAvailable);

                if (isOrbitAvailable && shipCameraSettings.isOrbitEnabled)
                {
                    EnableOrbit();
                }
        ...
        public virtual void ExportCameraSettings (ref ShipCameraSettings camSettings)
        {
            if (camSettings != null)
            {
                ...
                #region Orbit settings
                camSettings.isOrbitAvailable = isOrbitAvailable;
                camSettings.isOrbitEnabled = isOrbitEnabled;
                camSettings.orbitDistance = orbitDistance;
                camSettings.orbitHorizDamping = orbitHorizDamping;
                camSettings.orbitVertDamping = orbitVertDamping;
                camSettings.orbitSpeed = orbitSpeed;
                camSettings.orbitGroundMask = orbitGroundMask;
                camSettings.orbitGroundDetectOffset = orbitGroundDetectOffset;
                camSettings.isOrbitGroundDetection = isOrbitGroundDetection;
                #endregion
        ...
        #region Public API Non-Static Methods - Orbit
        ...
        /// <summary>
        /// Make the orbit feature available for use or unavailable.
        /// </summary>
        /// <param name="isAvailable"></param>
        public void SetIsOrbitAvailable (bool isAvailable)
        {
            isOrbitAvailable = isAvailable;

            if (isOrbitEnabled) { DisableOrbit(); }
        }
        ...
        #region Public API Non-Static Methods - Zoom
