...
namespace SciFiShipController
{
    ...
    public class ShipCameraSettings : ScriptableObject
    {
        ...
        /// </summary>
        public bool isOrbitAvailable = true;

        /// <summary>
        /// Enable or disable the ability to orbit the camera around the ship.
        /// </summary>
        public bool isOrbitEnabled = false;
        ...
        /// </summary>
        public LayerMask orbitGroundMask = ShipCameraModule.DefaultOrbitGroundMask;
        ...
        #region Public Variables - Special Purpose

        /// <summary>
        /// When applying these settings, snap the camera to the target location and rotation.
        /// NOTE: When false, this can still be overridden by the Ship Camera Changer with Always Snap to Target.
        /// </summary>
        public bool isSnapToTarget = false;
