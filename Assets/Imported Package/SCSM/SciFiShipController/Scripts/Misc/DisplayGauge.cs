...
namespace SciFiShipController
{
    ...
    public class DisplayGauge
    {
        ...
        /// <summary>
        /// The purpose of this gauge. Typically it comes from SSCGaugePurposes.
        /// In the future it could come from an optional ScriptableObject associated with the ShipDisplayModule.
        /// </summary>
        public int gaugePurposeKey;
        ...
        public DisplayGauge(DisplayGauge displayGauge)
        {
            ...
            else
            {
                ...
                gaugePurposeKey = displayGauge.gaugePurposeKey;
