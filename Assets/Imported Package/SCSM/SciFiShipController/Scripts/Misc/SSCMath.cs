...
namespace SciFiShipController
{
    ...
    public class SSCMath
    {
        ...
        /// <summary>
        /// Convert a number in one range, into a new range.
        /// </summary>
        ...
        {
            return oldMax-oldMin == 0f ? newMin : ((value - oldMin) / (oldMax - oldMin)) * (newMax - newMin) + newMin;
        }
        ...
        /// If "b" is equal to "a" this funtion will always return 0
        /// </summary>
        /// <param name="x"></param>
        /// <param name="a"></param>
        /// <param name="b"></param>
        ...
        /// Will default to Vector3.forward if close to or equal to Vector3.zero.
        /// </summary>
        ...
        /// <summary>
        /// Return the normalised direction or vForward if direction is equal to or very near Vector3.zero. 
        /// </summary>
        /// <param name="direction"></param>
        /// <param name="vForward">Default forward if direction is equal to or very near Vector3.zero</param>
        /// <returns></returns>
        public static Vector3 NormaliseWithDefault(Vector3 direction, Vector3 vForward)
        {
            if (direction.sqrMagnitude < Vector3.kEpsilon)
            {
                return vForward;
        ...
        /// <summary>
        /// Rotate a position around a point using the angle in degrees and the axis we want to rotate on.
        /// This should work using local space or world space.
        /// </summary>
        ...
        /// <returns></returns>
        public static Vector3 RotateAround (Vector3 position, Vector3 point, float angle, Vector3 axis)
        {
            return point + Quaternion.AngleAxis(angle, axis) * (position - point);
        }
        ...
        /// Start power calculation at power of zero instead of power of one.
        /// Currently used to calculate ship drag.
        /// </summary>
        /// <param name="baseNum"></param>
        /// <param name="indexNum"></param>
        /// <returns></returns>
        public static float IntPowS0(float baseNum, int powerNum)
        {
