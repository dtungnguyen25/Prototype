...
namespace SciFiShipController
{
    ...
    public class ShipDockingAdapter
    {
        ...
        /// <summary>
        /// Used to change the rotation when docking from a different direction by
        /// applying it to the ShipDockingStation point (rather than the adapter).
        /// </summary>
        [System.NonSerialized] public Vector3 offsetRelativeRotation;
        ...
        public void SetClassDefaults()
        {
            ...
            offsetRelativeRotation = Vector3.zero;
        }
        #endregion
    }
}