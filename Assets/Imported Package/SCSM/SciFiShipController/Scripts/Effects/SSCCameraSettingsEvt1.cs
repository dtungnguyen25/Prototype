...
namespace SciFiShipController
{
    ...
    /// </summary>
    [System.Serializable]
    public class SSCCameraSettingsEvt1 : UnityEvent<int, int, int, bool>
    {
        // onCameraSettingsChange
        // Param 1, Prev CammeraSettings number (1,2,3... OR 0 not set)
        // Param 2, New CammeraSettings number (1,2,3... OR 0 not set)
        // Param 3, ShipId (added in v1.4.4)
        // Param 4, future use
    }
}