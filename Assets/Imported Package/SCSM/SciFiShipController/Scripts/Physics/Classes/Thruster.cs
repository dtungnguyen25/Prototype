...
namespace SciFiShipController
{
    ...
    public class Thruster
    {
        ...
        /// <summary>
        /// See also thrusterForceUseStrings in ShipControlModuleEditor
        /// and thruster.forceUse in ship. Most of the time the forceUse
        /// references the ints directly. This enum was added in v1.5.4
        /// to assist users calling some APIs.
        /// </summary>
        public enum ThrusterForceInput
        {
            None = 0,
            ForwardThrust = 1,
            BackwardThrust = 2,
