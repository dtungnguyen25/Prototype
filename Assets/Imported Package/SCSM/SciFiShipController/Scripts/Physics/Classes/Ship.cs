...
namespace SciFiShipController
{
    ...
    public class Ship
    {
        ...
        /// <summary>
        /// Physics or Update Loop timing
        /// </summary>
        public enum SSCTiming
        {
            Auto = 0,
            Manual = 1
        }
        ...
        /// <summary>
        /// How cached move data is updated
        /// </summary>
        public enum SSCMoveDataUpdate
        {
            Auto = 0,
            Custom = 1
        }
        ...
        /// This is automatically set when "Calculate Drag Properties" is applied in the Aero tab.
        /// </summary>
        ...
        public bool autoCentrePitch = true;
        /// <summary>
        ...
        /// <summary>
        /// How quickly the ship pitches (in degrees per second) when pitch and roll is limited to a certain range.
        /// Only relevant when limitPitchAndRoll is set to true.
        /// </summary>
        [Range(10f, 90f)] public float pitchSpeed;
        /// <summary>
        /// How quickly the ship rolls (in degrees per second) when pitch and roll is limited to a certain range.
        /// Only relevant when limitPitchAndRoll is set to true.
        /// </summary>
        [Range(10f, 90f)] public float turnRollSpeed;
        /// <summary>
        /// Controls how much damping is used in pitch control to prevent overshoot of the target pitch to match.
        /// Increase this value if the ship oscillates (moves back and forth) near the target pitch angle. (Default 1.0).
        /// If changed at runtime, must call ReinitialisePitchRollMatchVariables().
        /// </summary>
        [Range(1f, 5f)] public float pitchDamping = 1f;
        /// <summary>
        /// Controls how much damping is used in roll control to prevent overshoot of the target roll to match.
        /// Increase this value if the ship oscillates (moves back and forth) near the target roll angle (Default 1.0).
        /// If changed at runtime, must call ReinitialisePitchRollMatchVariables().
        /// </summary>
        [Range(1f, 5f)] public float rollDamping = 1f;
        /// <summary>
        ...
        /// <summary>
        /// How quickly the ship pitches and rolls to match the target pitch and roll. Only relevant when limitPitchAndRoll in is set to true in arcade mode.
        /// </summary>
        ...
        /// If you modify this, call ReinitialiseGroundMatchVariables().
        /// </summary>
        [Range(1f, 50f)] public float maxGroundMatchAccelerationFactor;
        /// <summary>
        ...
        /// <summary>
        /// In some custom configurations the moment may return NaN or Infinity. Enabling this will reset the moment to zero to avoid errors. Do not enable unless you are getting NaN errors.
        /// </summary>
        public bool isCheckMomentValid;
        ...
        /// <summary>
        /// The ship will glide or hover when thrust is not being applied. When disabled, you will need to add a wing to provide lift.
        /// </summary>
        public bool counteractGravity;
        ...
        /// <summary>
        /// [INTERNAL ONLY]
        /// Use SetMoveDataUpdate(..)
        /// The way cached move data is updated
        /// </summary>
        public SSCMoveDataUpdate moveDataUpdate = SSCMoveDataUpdate.Auto;

        /// <summary>
        /// [INTERNAL ONLY]
        /// </summary>
        [System.NonSerialized] public int moveDataUpdateInt;
        ...
        /// <summary>
        /// [INTERNAL ONLY]
        /// Use SetTimingPhysicsLoop(..)
        /// </summary>
        public SSCTiming timingPhysicsLoop;

        /// <summary>
        /// [INTERNAL ONLY]
        /// </summary>
        [System.NonSerialized] public int timingPhysicsLoopInt;

        /// <summary>
        /// [INTERNAL ONLY]
        /// Use SetTimingUpdateLoop(..)
        /// </summary>
        public SSCTiming timingUpdateLoop;

        /// <summary>
        /// [INTERNAL ONLY]
        /// </summary>
        [System.NonSerialized] public int timingUpdateLoopInt;
        ...
        /// <summary>
        /// The unique model or type of ship. Values 1 to 100 are reserved for demo ships. 0 = Not Set.
        /// </summary>
        public int modelId;
        ...
        public static readonly int SSCTimingAutoInt = (int)SSCTiming.Auto;
        public static readonly int SSCTimingManualInt = (int)SSCTiming.Manual;

        public static readonly int SSCMoveDataAutoInt = (int)SSCMoveDataUpdate.Auto;
        public static readonly int SSCMoveDataCustomInt = (int)SSCMoveDataUpdate.Custom;
        ...
        public delegate void CallbackOnShieldDestroyed(Ship ship, DamageRegion damageRegion);
        ...
        public delegate void CallbackOnTimingPhysicsChanged(Ship ship, SSCTiming timingPhysics);
        public delegate void CallbackOnTimingUpdateChanged(Ship ship, SSCTiming timingUpdate);
        public delegate void CallbackOnMoveDataUpdate(Ship ship, Transform transform, Rigidbody rigidbody);
        ...
        /// <summary>
        /// Subscribe with a custom method to this to be notified immediately
        /// after a shield is destroyed. Your method must take 2
        /// parameters. This should be a lightweight method to avoid
        /// performance issues. It could be used to update a HUD or
        /// take some other action.
        /// </summary>
        [NonSerialized] public CallbackOnShieldDestroyed callbackOnShieldDestroyed = null;
        ...
        /// <summary>
        /// Subscribe with a custom method to this to be notified immediately after the weapon
        ...
        /// <summary>
        /// Subscribe to this to get notified when timingPhysicsLoop is changed.
        /// See also shipControlModule.callbackOnPhysicsLoop
        /// </summary>
        [NonSerialized] public CallbackOnTimingPhysicsChanged callbackOnTimingPhysicsChanged = null;

        /// <summary>
        /// Subscribe to this to get notified when timingUpdateLoop is changed.
        /// See also shipControlModule.callbackOnUpdateLoop
        /// </summary>
        [NonSerialized] public CallbackOnTimingUpdateChanged callbackOnTimingUpdateChanged = null;

        /// <summary>
        /// Subscribe with a custom method to this to be notified when you need to update the cached move data.
        /// Inside this method you must call ship.SetTransformData(..) and ship.SetRigidBodyData(..).
        /// </summary>
        [NonSerialized] public CallbackOnMoveDataUpdate callbackOnMoveDataUpdate = null;
        #endregion
        ...
        internal bool hasRemainingFuel = true;
        ...
        public Ship (Ship ship)
        {
            ...
            else
            {
                ...
                this.autoCentrePitch = ship.autoCentrePitch;
                ...
                this.counteractGravity = ship.counteractGravity;
        ...
        /// <summary>
        /// Reset the thruster systems variables and thruster throttle and heat values.
        ...
        /// <param name="shieldPenetration"></param>
        private void ApplyDamage(float damageAmount, ProjectileModule.DamageType damageType, Vector3 damagePosition, bool adjustForCollisionResistance, float shieldPenetration)
        {
            ...
            for (int i = 0; i < damageArrayLengths; i++)
            {
                ...
                if (regionDamaged)
                {
                    ...
                    if (thisDamageRegion.useShielding && thisDamageRegion.ShieldHealth > 0f)
                    {
                        ...
                        if (shieldPenetration > 0f)
                        {
                            regionDamaged = true;
                            // Reduce the actual damage to the underlying
                            // region if required.
                            actualDamage *= shieldPenetration;

                            // Will the damage region be destroyed?
                            // If so, the shield shouldn't survive either.
                            if (actualDamage >= thisDamageRegion.Health)
                            {
                        ...
                        else if (actualDamage >= thisDamageRegion.shieldingDamageThreshold)
                        {
                            ...
                            if (thisDamageRegion.ShieldHealth <= 0f)
                            {
                                ...
                                if (callbackOnShieldDestroyed != null) { callbackOnShieldDestroyed.Invoke(this, thisDamageRegion); }
                            }
                        }
                    }
        ...
        /// <summary>
        /// This gets called when a weapon fires and from FixedUpdate in BeamModule. It performs the following:
        ...
        /// <param name="deltaTime"></param>
        internal void MoveBeam(BeamModule beamModule, float deltaTime)
        {
            if (beamModule.isInitialised && beamModule.isBeamEnabled && beamModule.weaponIndex >= 0 && beamModule.firePositionIndex >= 0)
            {
                ...
                if ((weapon.weaponTypeInt == Weapon.FixedBeamInt || weapon.weaponTypeInt == Weapon.TurretBeamInt) && beamItemKey.beamSequenceNumber == beamModule.itemSequenceNumber)
                {
                    ...
                    // Check if this weapon can be manually fired
                    if (weaponFiringButtonInt != Weapon.FiringButtonManualInt)
                    {
                        weapon.isManualFireNow = false;
                    }

                    // For autofiring weapons, this will return false.
                    bool isReadyToFire = (pilotPrimaryFireInput && weaponFiringButtonInt == Weapon.FiringButtonPrimaryInt) || (pilotSecondaryFireInput && weaponFiringButtonInt == Weapon.FiringButtonSecondaryInt);

                    // If this is auto-firing or manual fired turret, check if it is ready to fire
                    if ((weaponFiringButtonInt == Weapon.FiringButtonAutoInt || weapon.isManualFireNow) && weapon.weaponTypeInt == Weapon.TurretBeamInt)
                    {
                    ...
                    // move fixed weapon beam
                    else if (!isReadyToFire && weapon.isManualFireNow && weapon.weaponTypeInt == Weapon.FixedBeamInt)
                    {
                        isReadyToFire = true;

                        /// TODO - FIX THIS FOR MULTIPLE BEAMS on same weapon
                        weapon.isManualFireNow = false;
                    }
                    ...
                    else
                    {
                        ...
                        if (Physics.Linecast(_weaponWSFirePos, _endPosition, out raycastHitInfo, ~0, QueryTriggerInteraction.Ignore))
                        {
                            ...
                            if (!BeamModule.CheckShipHit(raycastHitInfo, beamModule, deltaTime))
                            {
                                // If it hit an object with a DamageReceiver script attached, take appropriate action like call a custom method
                                BeamModule.CheckObjectHit(raycastHitInfo, beamModule, deltaTime);
                            }
                        ...
                        if (weapon.rechargeTime > 0f || weapon.isManualRecharge) { weapon.chargeAmount -= deltaTime * (weapon.heatLevel > weapon.overHeatThreshold ? 2f - weapon.currentPerformance : 1f) / beamModule.dischargeDuration; }

                        weapon.ManageHeat(deltaTime, 1f);
        ...
        public void SetClassDefaults()
        {
            ...
            this.modelId = 0; // NOT SET
            this.squadronId = -1; // NOT SET
        ...
        public void Initialise(Transform trfm)
        {
            ...
            //dragData = new PhysDragData();
            ReinitialiseDragVariables();
        ...
        /// </summary>
        public void ReinitialisePitchRollMatchVariables()
        {
            // New values, better for pipes
            pitchPIDController = new PIDController(0.5f, 0f, 0.1f * pitchDamping);
            rollPIDController = new PIDController(0.5f, 0f, 0.1f * rollDamping);
        ...
        #region Internal Cached Move Data
        ...
        /// Most of the time this should be automatically called for you.
        /// See also SetTransformData(..) and SetRigidBodyData(..)
        /// </summary>
        /// <param name="transform"></param>
        /// <param name="rigidbody"></param>
        public void UpdatePositionAndMovementData (Transform transform, Rigidbody rigidbody)
        {
            if (moveDataUpdateInt != SSCMoveDataCustomInt)
            {
            ...
            else if (callbackOnMoveDataUpdate != null)
            {
                callbackOnMoveDataUpdate.Invoke(this, transform, rigidbody);
            }
        }
        ...
        /// <param name="physicsDeltaTime">The Physics target time step in seconds</param>
        public void CalculateForceAndMoment(ref Vector3 localResultantForce, ref Vector3 localResultantMoment, float physicsDeltaTime)
        {
#if SSC_SHIP_DEBUG
            ...
            float _deltaTime = physicsDeltaTime;
            ...
            if (limitPitchAndRollEnabled)
            {
                ...
                if (autoCentrePitch)
                {
                    // Set pitch target to current pitch input
                    pitchAmountInput = pilotMomentInput.x * maxPitch;
                }
                else
                {
                    // Modify pitch target by current pitch input
                    pitchAmountInput += pilotMomentInput.x * pitchSpeed * physicsDeltaTime;
                    if (pitchAmountInput < -maxPitch) { pitchAmountInput = -maxPitch; }
                    else if (pitchAmountInput > maxPitch) { pitchAmountInput = maxPitch; }
                }
                ...
                // +SMS v1.4.7 Beta 3 - Vary pitch speed as it approaches the limits to make limit more subtle
                if (maxPitch > 0f)
                {
                    // Only apply when approaching limits
                    if (pilotMomentInput.x < 0f && pitchAmountInput < -maxPitch * 0.7f)
                    {
                        float pitchN = 1f - SSCMath.Normalise(-pitchAmountInput / maxPitch, 0.7f, 1f);
                        if (pitchN < 0.1f) { pitchN = 0.1f; }

                        maxFramePitchDelta = pitchN * pitchSpeed * _deltaTime;
                    }
                    else if (pilotMomentInput.x > 0f && pitchAmountInput > maxPitch * 0.7f)
                    {
                        float pitchN = 1f - SSCMath.Normalise(pitchAmountInput / maxPitch, 0.7f, 1f);
                        if (pitchN < 0.1f) { pitchN = 0.1f; }
                    ...
                    {
                        maxFramePitchDelta = pitchSpeed * _deltaTime;
                    }
                }
                else
                {
            ...
            // First check central fuel.
            hasRemainingFuel = useCentralFuel && centralFuelLevel > 0f;
            ...
            if (thrusterList != null)
            {
                ...
                for (componentIndex = 0; componentIndex < componentListSize; componentIndex++)
                {
                    ...
                    if (thruster.heatLevel >= 100f || (useCentralFuel ? centralFuelLevel <= 0f : thruster.fuelLevel <= 0f))
                    {
                        ...
                        // Only update if another thruster or central doesn't have fuel supply
                        if (!hasRemainingFuel && !useCentralFuel && thruster.fuelLevel > 0f) { hasRemainingFuel = true; }
                    ...
                    if (useCentralFuel)
                    {
                        // If there is no central fuel we will have exited above after calling ManageHeat().
            ...
            if (mediumDensity > 0f)
            {
                ...
                if (!disableDragMoments)
                {
                    ...
                    // Centre of drag is precalculated separately for each axis using "Calculate Drag Properties" button on Aero tab in Inspector
                ...
                {
                    // +SMS v1.4.5 Beta 3a - cache drag metrics in Initialise() and check if anything has changed.
                    // Check isCached first as the user could have updated an inspector slider etc.
                    if (!dragData.isCached || dragData.angularDragFactor != angularDragFactor || dragData.isPhysicsBasedModel != shipPhysicsModelPhysicsBased ||
                        dragData.centreOfMass != centreOfMass || dragData.dragReferenceAreas != dragReferenceAreas ||
                        dragData.centreOfDragXMoment != centreOfDragXMoment || dragData.centreOfDragYMoment != centreOfDragYMoment ||
                        dragData.centreOfDragZMoment != centreOfDragZMoment
                    )
                    {
                        dragData.isCached = false;
                        ReinitialiseDragVariables();
                    }
                    ...
                    // #SMS v1.4.5 Now cached in dragData - See SSCUtils.CalculateDragMetrics (ref PhysDragData physDragData)
                    ...
                    // Could these values be precalculated?
                    //quarticLengthXProj = SSCMath.IntPowS0((dragLength / 2) + centreOfMass.z - centreOfDragYMoment.z, 4) + SSCMath.IntPowS0((dragLength / 2) - centreOfMass.z + centreOfDragYMoment.z, 4);
                    //quarticLengthYProj = SSCMath.IntPowS0((dragLength / 2) + centreOfMass.z - centreOfDragXMoment.z, 4) + SSCMath.IntPowS0((dragLength / 2) - centreOfMass.z + centreOfDragXMoment.z, 4);
                    //quarticWidthYProj = SSCMath.IntPowS0((dragWidth / 2) + centreOfMass.x - centreOfDragZMoment.x, 4) + SSCMath.IntPowS0((dragWidth / 2) - centreOfMass.x + centreOfDragZMoment.x, 4);
                    //quarticWidthZProj = SSCMath.IntPowS0((dragWidth / 2) + centreOfMass.x - centreOfDragYMoment.x, 4) + SSCMath.IntPowS0((dragWidth / 2) - centreOfMass.x + centreOfDragYMoment.x, 4);
                    //quarticHeightXProj = SSCMath.IntPowS0((dragHeight / 2) + centreOfMass.y - centreOfDragZMoment.y, 4) + SSCMath.IntPowS0((dragHeight / 2) - centreOfMass.y + centreOfDragZMoment.y, 4);
                    //quarticHeightZProj = SSCMath.IntPowS0((dragHeight / 2) + centreOfMass.y - centreOfDragXMoment.y, 4) + SSCMath.IntPowS0((dragHeight / 2) - centreOfMass.y + centreOfDragXMoment.y, 4);
                    ...
                    // X-axis angular drag
                    localResultantMoment.x += mediumDensity / 8f * localAngularVelocity.x * localAngularVelocity.x * dragData.dragWidth *
                        dragCoefficients.y * dragData.quarticLengthYProj * (localAngularVelocity.x > 0f ? -1f : 1f) * dragData.angularDragMultiplier;
                    localResultantMoment.x += mediumDensity / 8f * localAngularVelocity.x * localAngularVelocity.x * dragData.dragWidth *
                        dragCoefficients.z * dragData.quarticHeightZProj * (localAngularVelocity.x > 0f ? -1f : 1f) * dragData.angularDragMultiplier;
                    // Y-axis angular drag
                    localResultantMoment.y += mediumDensity / 8f * localAngularVelocity.y * localAngularVelocity.y * dragData.dragHeight *
                        dragCoefficients.x * dragData.quarticLengthXProj * (localAngularVelocity.y > 0f ? -1f : 1f) * dragData.angularDragMultiplier;
                    localResultantMoment.y += mediumDensity / 8f * localAngularVelocity.y * localAngularVelocity.y * dragData.dragHeight *
                        dragCoefficients.z * dragData.quarticWidthZProj * (localAngularVelocity.y > 0f ? -1f : 1f) * dragData.angularDragMultiplier;
                    // Z-axis angular drag
                    localResultantMoment.z += mediumDensity / 8f * localAngularVelocity.z * localAngularVelocity.z * dragData.dragLength *
                        dragCoefficients.y * dragData.quarticWidthYProj * (localAngularVelocity.z > 0f ? -1f : 1f) * dragData.angularDragMultiplier;
                    localResultantMoment.z += mediumDensity / 8f * localAngularVelocity.z * localAngularVelocity.z * dragData.dragLength *
                        dragCoefficients.x * dragData.quarticHeightXProj * (localAngularVelocity.z > 0f ? -1f : 1f) * dragData.angularDragMultiplier;
                }
            ...
            if (!shipPhysicsModelPhysicsBased)
            {
                ...
                else
                {
                    ...
                    if ((forceInput.x > 0f) == (localVelocity.x < 0f) || forceInput.x == 0f)
                    {
                        // The force also optionally includes a component to counteract gravity on this axis
                        arcadeForceVector.x += -((localVelocity.x * 0.5f / _deltaTime) + (counteractGravity ? localGravityAcceleration.x : 0f));
                    }
                    if ((forceInput.y > 0f) == (localVelocity.y < 0f) || forceInput.y == 0f)
                    {
                        // The force also optionally includes a component to counteract gravity on this axis
                        arcadeForceVector.y += -((localVelocity.y * 0.5f / _deltaTime) + (counteractGravity ? localGravityAcceleration.y : 0f));
                    }
                    ...
                    {
                        // Re-enable gravity by removing the component of the vector that acts along the local gravity direction
                        arcadeForceVector = Vector3.ProjectOnPlane(arcadeForceVector, localGravityAcceleration);
                        // Set the z-component back to zero to remove any braking/accelerating force we inadvertently added
                        arcadeForceVector.z = 0f;
                    }
            ...
            #region Check Moment Valid
            if (isCheckMomentValid)
            {
                // Currently not checking for -ve Infinity. Might need to add that if it becomes an issue
                if (float.IsNaN(localResultantMoment.x) || float.IsNaN(localResultantMoment.y) || float.IsNaN(localResultantMoment.z) ||
                    float.IsInfinity(localResultantMoment.x) || float.IsInfinity(localResultantMoment.y) || float.IsInfinity(localResultantMoment.z))
                {
                    localResultantMoment = Vector3.zero;
                }
            }
        ...
        {
            UpdateWeaponsAndDamage(shipControllerManager, Time.deltaTime);
        }
        ...
        /// <param name="shipControllerManager"></param>
        /// <param name="deltaTime"></param>
        public void UpdateWeaponsAndDamage (SSCManager shipControllerManager, float deltaTime)
        {
            #region Initialisation
            ...
            for (componentIndex = 0; componentIndex < componentListSize; componentIndex++)
            {
                ...
                if (weapon.projectilePrefabID >= 0 || weapon.beamPrefabID >= 0)
                {
                    ...
                    // Avoid non-manual weapons firing
                    if (weaponFiringButtonInt != Weapon.FiringButtonManualInt)
                    {
                        weapon.isManualFireNow = false;
                    }
                    ...
                    weapon.ManageHeat(deltaTime, 0f);
                    ...
                    {
                        if (weaponTypeInt == Weapon.TurretProjectileInt || weaponTypeInt == Weapon.TurretBeamInt) { weapon.MoveTurret(worldVelocity, false, false); }
                        ...
                        {
                            if (!weapon.isManualRecharge)
                            {
                                weapon.chargeAmount += deltaTime * 1f / weapon.rechargeTime;
                            }
                        ...
                        {
                            //Debug.Log("[DEBUG] reloading " + weapon.reloadTimer);
                        ...
                        else if (shipDamageModelIsSimple || weapon.damageRegionIndex < 0 || weapon.Health > 0f)
                        {
                            ...
                            // If this is auto-firing or manual fire turret, check if it is ready to fire
                            if (!isReadyToFire && (weaponFiringButtonInt == Weapon.FiringButtonAutoInt || weapon.isManualFireNow) && (weaponTypeInt == Weapon.TurretProjectileInt || weaponTypeInt == Weapon.TurretBeamInt))
                            {
                                // Is turret locked on target and in direct line of sight?
                                // NOTE: If check LoS is enabled, it will still fire if another enemy is between the turret and the weapon.target.
                                isReadyToFire = weapon.isLockedOnTarget && (!weapon.checkLineOfSight || WeaponHasLineOfSight(weapon));
                            ...
                            // AutoFire, Fixed Projectile, with Missile from SSC Expansion Pack 1 (if installed)
                            else if (!isReadyToFire && weaponFiringButtonInt == Weapon.FiringButtonAutoInt && weaponTypeInt == Weapon.FixedProjectileInt && weapon.IsMissile)
                            {
                                // Currently location targets don't support LoS.
                                isReadyToFire = weapon.isLockedOnTarget && (!weapon.checkLineOfSight || weapon.isTargetLocation || WeaponHasLineOfSight(weapon));
                            }
                            // Manual fire for non-turret weapons
                            else if (!isReadyToFire && weapon.isManualFireNow && weaponTypeInt != Weapon.TurretProjectileInt && weaponTypeInt != Weapon.TurretBeamInt)
                            {
                                isReadyToFire = true;
                            }
                            ...
                            if (isReadyToFire && weapon.ammunition != 0)
                            {
                                ...
                                for (int fp = 0; fp < firePositionListCount; fp++)
                                {
                                    ...
                                    if (weapon.ammunition != 0)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            bool isGuidedToTarget = weapon.isProjectileKGuideToTarget || weapon.IsMissile;
                                            InstantiateProjectileParameters ipParms = new InstantiateProjectileParameters()
                                            {
                                                ...
                                                shipId = shipId,
                                                squadronId = squadronId,
                                                targetShip = isGuidedToTarget ? weapon.targetShip : null,
                                                targetGameObject = isGuidedToTarget ? weapon.target : null,
                                                targetguidHash = isGuidedToTarget ? weapon.targetguidHash : 0,
                                        ...
                                        // If required, pause the turret from moving after firing
                                        if (weapon.turretMoveDelay > 0f && weapon.IsMissile) { weapon.turretMoveDelayTimer = weapon.turretMoveDelay; }
                                ...
                                if (heatValue > 0f) { weapon.ManageHeat(deltaTime, heatValue); }
            ...
            if (!Destroyed())
            {
                if (respawningMode == RespawningMode.RespawnAtLastPosition)
                {
                    ...
                    collisionRespawnPositionTimer += deltaTime;
        ...
        public void ApplyCollisionDamage (Collision collisionInfo)
        {
            ...
            if (!attachedCollisionColliders.Contains(hitColliderID))
            {
                ...
                for (int c = 0; c < numberOfContactPoints; c++)
                {
                    ...
                    ApplyDamage(damageAtEachPoint, ProjectileModule.DamageType.Default, collisionInfo.GetContact(c).point, true, 0f);
                }
        ...
        {
            ApplyDamage(damageAmount, ProjectileModule.DamageType.Default, damagePosition, false, 0f);
            // Remember that this was collision damage
            lastDamageWasCollisionDamage = true;
        }
        ...
        /// <summary>
        /// Applies a specified amount of damage to the ship at a specified position.
        /// The optional parmeter shieldPenetration accepts a value between 0.0 and 1.0.
        /// 0 = has no affect on shields, while 1.0 fully penetrates the shield and applies
        /// full damage to the area protected by the shield.
        /// </summary>
        /// <param name="damageAmount"></param>
        /// <param name="damageType"></param>
        /// <param name="damagePosition"></param>
        /// <param name="shieldPenetration"></param>
        public void ApplyNormalDamage(float damageAmount, ProjectileModule.DamageType damageType, Vector3 damagePosition, float shieldPenetration = 0f)
        {
            ApplyDamage(damageAmount, damageType, damagePosition, false, shieldPenetration);
        ...
        #region Aero API Methods

        /// <summary>
        /// Typically only called from an editor script to show that properties affecting drag have been changed.
        /// </summary>
        public void DirtyDragCache()
        {
            dragData.isCached = false;
        }

        /// <summary>
        /// Refresh stale drag variables
        /// </summary>
        public void ReinitialiseDragVariables()
        {
            dragData.isPhysicsBasedModel = shipPhysicsModelPhysicsBased;
            dragData.centreOfMass = centreOfMass;
            dragData.angularDragFactor = angularDragFactor;
            dragData.centreOfDragXMoment = centreOfDragXMoment;
            dragData.centreOfDragYMoment = centreOfDragYMoment;
            dragData.centreOfDragZMoment = centreOfDragZMoment;
            dragData.dragReferenceAreas = dragReferenceAreas;
            SSCUtils.CalculateDragMetrics(ref dragData);
        }

        #endregion

        #region Timing and cached Move Data API Methods

        /// <summary>
        /// Set the way cached move data is updated.
        /// See also SetTransformData(..), SetRigidBodyData(..), and
        /// callbackOnMoveDataUpdate.
        /// </summary>
        /// <param name="newMoveDataUpdate"></param>
        public void SetMoveDataUpdate (SSCMoveDataUpdate newMoveDataUpdate)
        {
            moveDataUpdate = newMoveDataUpdate;
            moveDataUpdateInt = (int)moveDataUpdate;
        }

        /// <summary>
        /// When moveDataUpdate is Custom, call to manually update cached data from your callbackOnMoveDataUpdate method.
        /// </summary>
        /// <param name="positionWS"></param>
        /// <param name="rotationWS"></param>
        /// <param name="linearVelocity"></param>
        /// <param name="angularVelocity"></param>
        /// <param name="inertiaTensor"></param>
        public void SetRigidBodyData (Vector3 positionWS, Quaternion rotationWS, Vector3 linearVelocity, Vector3 angularVelocity, Vector3 inertiaTensor)
        {
            if (moveDataUpdateInt == SSCMoveDataCustomInt)
            {
                rbodyPos = positionWS;
                ...
                rbodyRight = rbodyRot * Vector3.right;
                rbodyUp = rbodyRot * Vector3.up;
                worldVelocity = linearVelocity;
                worldAngularVelocity = angularVelocity;
                localVelocity = rbodyInvRot * worldVelocity;
                localAngularVelocity = rbodyInvRot * worldAngularVelocity;
                rBodyInertiaTensor = inertiaTensor;
            }
        }

        /// <summary>
        /// Set the timing method used with the physics update loop
        /// </summary>
        /// <param name="newTiming"></param>
        public void SetTimingPhysicsLoop (SSCTiming newTiming)
        {
            SSCTiming oldTiming = timingPhysicsLoop;

            timingPhysicsLoop = newTiming;
            timingPhysicsLoopInt = (int)timingPhysicsLoop;

            // Has it changed?
            if (shipId != 0 && oldTiming != newTiming)
            {
                if (callbackOnTimingPhysicsChanged != null) { callbackOnTimingPhysicsChanged.Invoke(this, newTiming); }
            }
        }

        /// <summary>
        /// Set the timing method used with the update loop
        /// </summary>
        /// <param name="newTiming"></param>
        public void SetTimingUpdateLoop (SSCTiming newTiming)
        {
            SSCTiming oldTiming = timingUpdateLoop;

            timingUpdateLoop = newTiming;
            timingUpdateLoopInt = (int)timingUpdateLoop;

            // Has it changed?
            if (shipId != 0 && oldTiming != newTiming)
            {
                if (callbackOnTimingUpdateChanged != null) { callbackOnTimingUpdateChanged.Invoke(this, newTiming); }
            }
        }
        ...
        /// <param name="positionWS"></param>
        /// <param name="rotationWS"></param>
        public void SetTransformData (Vector3 positionWS, Quaternion rotationWS)
        {
            if (moveDataUpdateInt == SSCMoveDataCustomInt)
            {
                trfmPos = positionWS;
                trfmRot = rotationWS;
                trfmFwd = trfmRot * Vector3.forward;
                trfmRight = trfmRot * Vector3.right;
                trfmUp = trfmRot * Vector3.up;                
                trfmInvRot = Quaternion.Inverse(trfmRot);
            }
        }
        ...
        /// After calling this once or multiple times after the ship is initialised,
        /// for projectile weapons call:
        /// shipControlModule.ReinitialiseShipProjectilesAndEffects().
        /// If a beam weapon was added, call shipConrolModule.ReinitialiseShipBeams().
        /// </summary>
        ...
        /// <summary>
        /// Attempt to manually fire the weapon. Before using,
        /// call SetWeaponManualFire(weapon).
        /// For performance reasons, it doesn't check if weapon is null
        /// </summary>
        /// <param name="weapon"></param>
        public void FireWeaponIfReady (Weapon weapon)
        {
            weapon.isManualFireNow = true;
        }
        ...
        /// </summary>
        /// <param name="weapon"></param>
        public void SetWeaponAutoFire (Weapon weapon)
        {
            if (weapon != null)
            {
                weapon.isManualFireNow = false;
                weapon.firingButton = Weapon.FiringButton.AutoFire;
                weapon.isAutoTargetingEnabled = true;
            }
        }

        /// <summary>
        /// For manually firing the weapon. After this is set,
        /// call FireWeaponIfReady(weapon) to fire the weapon.
        /// </summary>
        public void SetWeaponManualFire (Weapon weapon)
        {
            if (weapon != null)
            {
                weapon.isManualFireNow = false;
                weapon.firingButton = Weapon.FiringButton.ManualFire;
                weapon.isAutoTargetingEnabled = false;
            }
        }
        ...
        /// <summary>
        /// Sets the target location that the weapon will attempt to aim at. This assumes the weapon
        /// is equipped with missiles from Expansion Pack 1 (if installed) that can target a Location.
        /// WARNING: For the sake of performance, does not validate weaponIdx or WeaponType.
        /// </summary>
        /// <param name="weaponIdx"></param>
        /// <param name="targetLocation"></param>
        public void SetWeaponTargetLocation (int weaponIdx, LocationData targetLocation)
        {
            // Currently don't check weapon type or number of weapons as this would incur overhead.
            if (weaponIdx >= 0)
            {
                // Call SetTargetLocation so it is configured correctly rather than setting the public variable
                weaponList[weaponIdx].SetTargetLocation(targetLocation);
            }
        }
